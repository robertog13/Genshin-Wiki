...
export const SplashArt = styled.img<{margin?: number,padding?: number,borderradios?: number, backColor?: string, border?: string, transition?: number, widthHover?: number, isClick?: boolean}>`
  ...
  &:hover{
    filter: ${({isClick}) => `drop-shadow(${(isClick ? `10px -8px 4px #42ecde` : "")})`}
  };
`
...
export const Title = styled.h1<{size?: string, aling?: string, maxWidth?: number}>`
