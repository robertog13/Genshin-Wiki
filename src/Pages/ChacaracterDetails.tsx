...
const CharacterDetails: React.FC = () => {
  ...
  const nameCharacter: string = String(id);
  ...
  return (
    <div>
      <Header
        title={capName}
        element={characterDetail?.vision?.toLowerCase()}
      />
      {isLoading ? (
        <div>
          <Loading />
        ...
        <div>
          <SecondSection>
            <Galery>
              <SplashArt
                width={450}
                src={`${baseURL}/characters/${nameCharacter}/card.png`}
                alt={capName}
              />
            </Galery>
            <SecondSectionInfo>
              <Title color="gray100" aling="center" size="80px">
                {capName}
              </Title>
              <Title color="green300" size="25px" maxWidth={500}>
          ...
          <ThirdSection>
            <ThirdSectionInfo>
              <Title color="green300" size="50px">
                Constelações
              </Title>
              {characterDetail?.constellations?.map((constellation, index) => (
                <div key={index}>
                  <Title color="green200">
                    {constellation.level}º:{constellation.name}
                  </Title>
            ...
            <SplashArt
              ...
              borderradios={1000}
              padding={50}
              src={`${baseURL}/characters/${nameCharacter}/constellation.png`}
            />
          </ThirdSection>

          <SecondSection>
            <SecondSectionInfo>
              <Title color="gray100" size="50px">
                Habilidades
              </Title>
              ...
              {characterDetail?.passiveTalents?.map((passive, index) => (
                <div key={index}>
                  <Title color="green100" size="30px">
                    {passive.name}
                  </Title>
            ...
            <GaleryAtifacts>
              <SplashArt
                width={200}
                padding={30}
                src={`${baseURL}/characters/${id}/talent-passive-0.png`}
              />
              <SplashArt
                width={200}
                padding={30}
                src={`${baseURL}/characters/${id}/talent-passive-1.png`}
              />
              <SplashArt
                width={200}
                padding={30}
                src={`${baseURL}/characters/${id}/talent-passive-2.png`}
              />
            </GaleryAtifacts>
          </SecondSection>
          <SecondSection>
            <SecondSectionInfo>
              ...
              {characterDetail?.skillTalents?.map((skill, index) => (
                <div key={index}>
                  <Title size="30px" color="green100">
                    {skill.name}
                  </Title>
            ...
            <GaleryAtifacts>
              <SplashArt
                width={200}
                padding={30}
                src={`${baseURL}/characters/${id}/talent-skill.png`}
              />
              <SplashArt
                width={200}
                padding={30}
                src={`${baseURL}/characters/${id}/talent-burst.png`}
              />
              <SplashArt
                width={200}
                padding={30}
                src={`${baseURL}/characters/${id}/talent-na.png`}
              />
            </GaleryAtifacts>
          </SecondSection>
        </div>
